...
public class Total {
    ...
    public Total withICMSTot(ICMSTot iCMSTot) {
        this.iCMSTot = iCMSTot;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("iCMSTot");
        sb.append('=');
        sb.append(((this.iCMSTot == null)?"<null>":this.iCMSTot));
        sb.append(',');
    ...
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((this.iCMSTot == null)? 0 :this.iCMSTot.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((this.iCMSTot == rhs.iCMSTot)||((this.iCMSTot!= null)&&this.iCMSTot.equals(rhs.iCMSTot)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
