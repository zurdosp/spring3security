...
public class MunicipioJurisdicao {
    ...
    public MunicipioJurisdicao withCodigo(String codigo) {
        this.codigo = codigo;
        return this;
    }
    ...
    public MunicipioJurisdicao withDescricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
    ...
    public MunicipioJurisdicao withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(MunicipioJurisdicao.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("codigo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MunicipioJurisdicao) == false) {
            return false;
        }
        MunicipioJurisdicao rhs = ((MunicipioJurisdicao) other);
