...
public class NaturezaJuridica {
    ...
    public NaturezaJuridica withCodigo(String codigo) {
        this.codigo = codigo;
        return this;
    }
    ...
    public NaturezaJuridica withDescricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
    ...
    public NaturezaJuridica withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(NaturezaJuridica.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("codigo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NaturezaJuridica) == false) {
            return false;
        }
        NaturezaJuridica rhs = ((NaturezaJuridica) other);
