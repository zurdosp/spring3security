...
public class CnpjConsultQsa {
    ...
    public CnpjConsultQsa withNi(String ni) {
        this.ni = ni;
        return this;
    }
    ...
    public CnpjConsultQsa withTipoEstabelecimento(String tipoEstabelecimento) {
        this.tipoEstabelecimento = tipoEstabelecimento;
        return this;
    }
    ...
    public CnpjConsultQsa withNomeEmpresarial(String nomeEmpresarial) {
        this.nomeEmpresarial = nomeEmpresarial;
        return this;
    }
    ...
    public CnpjConsultQsa withNomeFantasia(String nomeFantasia) {
        this.nomeFantasia = nomeFantasia;
        return this;
    }
    ...
    public CnpjConsultQsa withSituacaoCadastral(SituacaoCadastral situacaoCadastral) {
        this.situacaoCadastral = situacaoCadastral;
        return this;
    }
    ...
    public CnpjConsultQsa withNaturezaJuridica(NaturezaJuridica naturezaJuridica) {
        this.naturezaJuridica = naturezaJuridica;
        return this;
    }
    ...
    public CnpjConsultQsa withDataAbertura(String dataAbertura) {
        this.dataAbertura = dataAbertura;
        return this;
    }
    ...
    public CnpjConsultQsa withCnaePrincipal(CnaePrincipal cnaePrincipal) {
        this.cnaePrincipal = cnaePrincipal;
        return this;
    }
    ...
    public CnpjConsultQsa withEndereco(Endereco endereco) {
        this.endereco = endereco;
        return this;
    }
    ...
    public CnpjConsultQsa withMunicipioJurisdicao(MunicipioJurisdicao municipioJurisdicao) {
        this.municipioJurisdicao = municipioJurisdicao;
        return this;
    }
    ...
    public CnpjConsultQsa withTelefones(List<Telefone> telefones) {
        this.telefones = telefones;
        return this;
    }
    ...
    public CnpjConsultQsa withCorreioEletronico(String correioEletronico) {
        this.correioEletronico = correioEletronico;
        return this;
    }
    ...
    public CnpjConsultQsa withCapitalSocial(Integer capitalSocial) {
        this.capitalSocial = capitalSocial;
        return this;
    }
    ...
    public CnpjConsultQsa withPorte(String porte) {
        this.porte = porte;
        return this;
    }
    ...
    public CnpjConsultQsa withSituacaoEspecial(String situacaoEspecial) {
        this.situacaoEspecial = situacaoEspecial;
        return this;
    }
    ...
    public CnpjConsultQsa withDataSituacaoEspecial(String dataSituacaoEspecial) {
        this.dataSituacaoEspecial = dataSituacaoEspecial;
        return this;
    }
    ...
    public CnpjConsultQsa withInformacoesAdicionais(InformacoesAdicionais informacoesAdicionais) {
        this.informacoesAdicionais = informacoesAdicionais;
        return this;
    }
    ...
    public CnpjConsultQsa withSocios(List<Socio> socios) {
        this.socios = socios;
        return this;
    }
    ...
    public CnpjConsultQsa withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CnpjConsultQsa.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ni");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CnpjConsultQsa) == false) {
            return false;
        }
        CnpjConsultQsa rhs = ((CnpjConsultQsa) other);
