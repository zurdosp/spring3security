...
public class CnaePrincipal {
    ...
    public CnaePrincipal withCodigo(String codigo) {
        this.codigo = codigo;
        return this;
    }
    ...
    public CnaePrincipal withDescricao(String descricao) {
        this.descricao = descricao;
        return this;
    }
    ...
    public CnaePrincipal withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CnaePrincipal.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("codigo");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CnaePrincipal) == false) {
            return false;
        }
        CnaePrincipal rhs = ((CnaePrincipal) other);
